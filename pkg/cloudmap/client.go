...
type ServiceDiscoveryClient interface {
	// ListNamespaces returns a list of all namespace names in AWS Cloud Map
...
func (sdc *serviceDiscoveryClient) ListNamespaces(ctx context.Context) (nsNames []string, err error) {
