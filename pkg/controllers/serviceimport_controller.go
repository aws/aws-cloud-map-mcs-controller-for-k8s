...
//+kubebuilder:rbac:groups=multicluster.k8s.aws,resources=serviceimports,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=multicluster.k8s.aws,resources=serviceimports/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=multicluster.k8s.aws,resources=serviceimports/finalizers,verbs=update
...
func (r *ServiceImportReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	_ = r.Log.WithValues("serviceimport", req.NamespacedName)
...
func (r *ServiceImportReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&multiclusterv1alpha1.ServiceImport{}).
		Complete(r)
}
